...
class MCSoftContrastiveLoss(nn.Module):
    ...
    """
    def __init__(self, init_negative_scale=5,init_shift=5,num_samples=7,uniform_lambda=10,vib_beta=0.001,reduction='sum'):
        super().__init__()
    ...
    def pairwise_sampling(self, anchors, candidates):
        ...
        #1024 000   1024 012345   1024 1-1-1-1-1 1
